...
@section('cuerpo_panel')
    ...
    <section>
        ...
        <form method="POST" action="{{ route('especialidad.update', $especialidad->id) }}" id="formulario_especialidad" class="formulario">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-10">
                    ...
                    <textarea type="text" class="form-control" id="descripcion" name="descripcion" value="{{ $especialidad->descripcion }}">{{ $especialidad->descripcion }}</textarea>
                </div>
            </div>
