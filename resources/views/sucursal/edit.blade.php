...
@section('cuerpo_panel')
    ...
    <section>
        ...
        <form method="UPDATE" action="" id="formulario_sucursal" class="formulario">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" value="{{ $sucursales[0]->nombre }}">
                </div>
                <div class="form-group col-md-4">
                    <label for="direccion">
                        <h6>Dirección</h6>
                    </label>
                    <input type="text" class="form-control" id="direccion" name="direccion" value="{{ $sucursales[0]->direccion }}">
                </div>
                <div class="form-group col-md-4">
                    <label for="telefono">
                        <h6>Teléfono</h6>
                    </label>
                    <input type="number" class="form-control" id="telefono" name="telefono" placeholder="Ej: 4 554 4444" value="{{ $sucursales[0]->telefono }}">
                </div>
            </div>
